      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content bg-light text-dark">
          ...
          <div class="modal-body">
            <form>
              <input placeholder="Titre" type="text" className={(() => {
              ...
              <textarea className="form-control form-control-lg form-group" placeholder="Description" value={this.props.config.description} onChange={e => {
              ...
              <div className="d-flex justify-content-between">
                <span>Priorité:</span>
                <StarRating default={this.props.config.priority} nbStar={5} color="#17A2B8" editable={true} fallback={val => {
                    this.props.configEditModal({priority: val});
                  }}/>
              </div>
              <div className="d-flex justify-content-between">
                <span>Difficulté:</span>
                <StarRating default={this.props.config.difficulty} nbStar={5} color="#FF770F" editable={true} fallback={val => {
